        ...
        >
            ...
            >
                ...
                {Object.keys(skills).length > 0 && (
                    <>
                        <div style={{ fontSize: 10, color: '#5a6488', fontWeight: 700, marginBottom: 4 }}>
                            스킬
                        </div>
                        {Object.entries(skills).map(([key, meta]) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        <span style={{ fontSize: 12, fontWeight: 700, color: '#ff9b30' }}>
                                            {meta?.name ?? key}
                                        </span>
                                        {cd > 0 && (
                                            <span style={{ fontSize: 9, color: '#ff3355', fontWeight: 700 }}>
                                                쿨 {cd}턴
                                            </span>
                                        )}
                                    </div>
                                    ...
                                    {dmgStr && (
                                        <div style={{ fontSize: 10, color: '#e8ecf8', marginTop: 3 }}>
                                            수치: {dmgStr}
                                        </div>
                                    )}

                                    {(meta as any)?.description && (
                                        <div style={{ fontSize: 9, color: '#8a94b8', marginTop: 2 }}>
                                            {(meta as any).description}
                                        </div>
                                    )}
                                </div>

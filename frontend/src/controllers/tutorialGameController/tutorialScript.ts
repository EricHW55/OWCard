...
export const TUTORIAL_SCRIPT: TutorialScriptAction[] = [
  ...
  { type: 'player_place', cardKey: 'soldierA', zone: 'main', slotIndex: 0, hint: '솔저 A를 본대 딜러 칸에 배치하세요.' },
  ...
  { type: 'auto_place', owner: 'opponent', cardKey: 'hazard', zone: 'main', delayMs: 900 },
  { type: 'auto_end_placement', owner: 'opponent', delayMs: 700 },
  { type: 'auto_end_turn', owner: 'opponent', delayMs: 700 },
  ...
  { type: 'player_skill', casterUid: 'tut-soldier-a', targetUid: 'tut-hazard', hint: '솔저 A를 선택한 뒤 해저드를 공격하세요.' },
  { type: 'tooltip', tooltip: { speaker: '튜토리얼', text: '해저드를 공격한 영웅은 반격 피해를 받습니다.' } },
  { type: 'auto_place', owner: 'opponent', cardKey: 'reaper1', zone: 'main', slotIndex: 0, delayMs: 900 },
  { type: 'auto_end_placement', owner: 'opponent', delayMs: 700 },
  { type: 'auto_skill', owner: 'opponent', casterUid: 'tut-hazard', targetUid: 'tut-winston', delayMs: 900 },
  { type: 'auto_end_turn', owner: 'opponent', delayMs: 700 },
  { type: 'player_place', cardKey: 'ana', zone: 'main', slotIndex: 0, hint: '아나를 본대 힐러 칸에 배치하세요.' },
  ...
  { type: 'auto_end_turn', owner: 'opponent', delayMs: 700 },
  { type: 'player_place', cardKey: 'soldierB', zone: 'side', hint: '솔저 B를 사이드 딜러 칸에 배치하세요.' },
  ...
  { type: 'player_skill', casterUid: 'tut-soldier-a', targetUid: 'tut-reaper-1', hint: '솔저 A로 리퍼 1을 공격하세요.' },
  { type: 'auto_skill', owner: 'opponent', casterUid: 'tut-reaper-1', targetUid: 'tut-winston', delayMs: 900 },
  { type: 'auto_end_turn', owner: 'opponent', delayMs: 700 },
  { type: 'tooltip', tooltip: { speaker: '튜토리얼', text: '추가 생명력은 피해를 먼저 흡수하고, 지속 시간이 끝나면 사라집니다.' } },
  { type: 'player_skill', casterUid: 'tut-soldier-b', targetUid: 'tut-reaper-1', hint: '사이드의 솔저 B로 리퍼 1을 제거하세요.' },
  { type: 'player_skill', casterUid: 'tut-soldier-a', targetUid: 'tut-reaper-2', hint: '솔저 A로 리퍼 2를 공격하세요.' },
  { type: 'player_skill', casterUid: 'tut-winston', targetUid: 'tut-reaper-2', hint: '윈스턴으로 리퍼 2를 이어서 공격하세요.' },
  { type: 'auto_skill', owner: 'opponent', casterUid: 'tut-reaper-2', targetUid: 'tut-soldier-b', delayMs: 900 },
  { type: 'tooltip', tooltip: { speaker: '튜토리얼', text: '사이드 영웅은 탱커가 있어도 상대 공격 대상이 될 수 있습니다.' } },
  { type: 'player_skill', casterUid: 'tut-ana', targetUid: 'tut-reaper-2', hint: '아나로 리퍼 2를 제거하세요.' },

...
const GLOBAL_EXTRA_TO_SKILL_KEY: Record<string, Record<string, string>> = {
    ...
    hazard: { hazard_retaliate: 'passive', hazard_wall_hp: 'skill_1', hazard_wall_description: 'skill_1' },
    ...
    torbjorn: { turret_hp: 'passive', turret_damage: 'passive', turret_description: 'passive', repair_amount: 'skill_2' },
    ...
    illari: { turret_hp: 'passive', turret_heal: 'passive', pylon_description: 'passive' },
